...
public class NotesFragment extends Fragment implements ItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        noteslist=new RecyclerView(getActivity());
        noteslist.setItemAnimator(new DefaultItemAnimator());
     //  View v= inflater.inflate(R.layout.notes_cell, container, false);

        noteslist.setLayoutManager(new LinearLayoutManager(getActivity()));
         notesAdapter=new NotesAdapter(notesItemList, getContext());
        noteslist.setAdapter(notesAdapter);

//notesAdapter.setOnItemClickListener((ItemClickListener) this);
        return noteslist;
    ...
    public void onItemClick(View view, int postion) {
        Toast.makeText(getActivity(),"xyx",Toast.LENGTH_SHORT).show();
    }
