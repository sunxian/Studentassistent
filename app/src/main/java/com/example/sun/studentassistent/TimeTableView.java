    ...
    private View getMode(final TimeTableModel model) {
        ...
        mTimeTableView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent();
                i.putExtra("sn",model.getStartnum());
                i.putExtra("course",model.getName());
                i.putExtra("en",model.getEndnum());
                i.putExtra("week",model.getWeek());
                i.putExtra("st",model.getStarttime());
                i.putExtra("et",model.getEndtime());
                i.putExtra("teacher",model.getTeacher());
                i.putExtra("weeknum",model.getWeeknum());
                i.putExtra("classroom",model.getClassroom());
                i.setClass(getContext(),CourseDetailActivity.class);
